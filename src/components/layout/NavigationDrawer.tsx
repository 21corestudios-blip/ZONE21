  ...
  return (
    <>
      ...
      >
        ...
        <nav className="mt-12 flex flex-col gap-6 overflow-y-auto px-6 md:px-12" aria-label="Navigation principale du menu">
          {primaryLinks.map((item) => (
            <Link key={item.name} href={item.href} className="group flex w-max items-center" onClick={onClose}>
