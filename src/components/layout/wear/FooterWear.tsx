        ...
        <div className="grid grid-cols-1 gap-16 md:grid-cols-12 md:gap-8">
          <div className="flex flex-col gap-8 md:col-span-8">
            ...
            <p className="max-w-sm font-sans text-sm font-light leading-relaxed text-white/60 md:text-base">
              L&apos;Essence de la matière. Une collection structurée pour traverser les époques
              avec autorité.
            </p>
          ...
          <div className="flex flex-col gap-6 md:col-span-4 md:pl-12">
            ...
            <Link href="/wear/livraison" className={footerLinkClassName}>
              Livraison &amp; Retours
            </Link>

            <Link href="/wear/guide-tailles" className={footerLinkClassName}>
              Guide des Tailles
            </Link>

            <Link href="/contact" className={`${footerLinkClassName} mt-4 md:mt-0`}>
              Nous Contacter
            </Link>
          </div>
        </div>
