...
// J'ai enrichi vos produits avec priceNum, category, gender et color
const products = [
  { id: 1, name: "Casquette Street Code", subtitle: "Noir / Coton", price: "45€", priceNum: 45, category: "Accessoires", gender: "Unisexe", color: "Noir", image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?q=80&w=800&auto=format&fit=crop", isNew: true },
  { id: 2, name: "Snapback Signal", subtitle: "Noir / Structure affirmée", price: "49€", priceNum: 49, category: "Accessoires", gender: "Unisexe", color: "Noir", image: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?q=80&w=800&auto=format&fit=crop" },
  { id: 3, name: "Trucker District", subtitle: "Noir / Maille respirante", price: "45€", priceNum: 45, category: "Accessoires", gender: "Unisexe", color: "Noir", image: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?q=80&w=800&auto=format&fit=crop" },
  { id: 4, name: "Bonnet Block", subtitle: "Noir / Maille douce", price: "39€", priceNum: 39, category: "Accessoires", gender: "Unisexe", color: "Noir", image: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=800&auto=format&fit=crop" },
  { id: 5, name: "Tote Bag Transit", subtitle: "Écru / Toile robuste", price: "35€", priceNum: 35, category: "Accessoires", gender: "Unisexe", color: "Beige", image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=800&auto=format&fit=crop" },
  { id: 6, name: "Polo Concrete", subtitle: "Noir / Maille piquée", price: "75€", priceNum: 75, category: "Vêtements", gender: "Homme", color: "Noir", image: "https://images.unsplash.com/photo-1520975954732-57dd22299614?q=80&w=800&auto=format&fit=crop" },
  { id: 7, name: "T-Shirt Street Line", subtitle: "Noir / 100% coton", price: "65€", priceNum: 65, category: "Tee-shirts", gender: "Homme", color: "Noir", image: "https://images.unsplash.com/photo-1521572267360-ee0c2909d518?q=80&w=800&auto=format&fit=crop" },
  { id: 8, name: "T-Shirt Oversized Motion", subtitle: "Noir / Coupe ample", price: "75€", priceNum: 75, category: "Tee-shirts", gender: "Unisexe", color: "Noir", image: "https://images.unsplash.com/photo-1503341504253-dff4815485f1?q=80&w=800&auto=format&fit=crop" },
  { id: 9, name: "Jogging Urban Flow", subtitle: "Noir / Molleton premium", price: "95€", priceNum: 95, category: "Vêtements", gender: "Homme", color: "Noir", image: "https://images.unsplash.com/photo-1506629905607-d9b1c31f3c84?q=80&w=800&auto=format&fit=crop" },
  { id: 10, name: "Sweat City Code", subtitle: "Noir / Coupe régulière", price: "110€", priceNum: 110, category: "Sweats", gender: "Homme", color: "Noir", image: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=800&auto=format&fit=crop" },
  { id: 11, name: "Hoodie Urban Core", subtitle: "Noir / Intérieur molletonné", price: "120€", priceNum: 120, category: "Sweats", gender: "Homme", color: "Noir", image: "https://images.unsplash.com/photo-1496747611176-843222e1e57c?q=80&w=800&auto=format&fit=crop" },
];

export default function UrbanBoutiquePage() {
              ...
              {filteredProducts.map((product) => (
                <div key={product.id} className="group relative flex flex-col gap-4 cursor-pointer">
                  <div className="relative w-full aspect-[3/4] overflow-hidden bg-[#1a1918]">
                    <Image
                      src={product.image}
                      alt={`${product.name} - Urban Collection`}
                      fill
