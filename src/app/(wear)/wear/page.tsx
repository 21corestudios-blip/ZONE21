...
export default function WearPage() {
  return (
    <div className="flex flex-col min-h-screen bg-[#F7F5F0]">
      ...
      {/* 1. LE HERO DE LA MARQUE (Style "Affiche" calqué sur l'accueil) */}
      <section className="relative w-full h-[60dvh] md:h-[70dvh] overflow-hidden bg-[#121110]">
        ...
        {/* Le voile photographique pour la lisibilité du texte en bas */}
        ...
        {/* Le titre ancré en bas de page (Sur une seule ligne) */}
